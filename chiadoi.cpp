...
void show(int n, double a, double b, double m, double fm, double ss)
{
    cout<<'\n'<<setw(3)<<roundf(n * 10000)/10000<<setw(8)<<roundf(a * 10000)/10000<<setw(8)<<roundf(b * 10000)/10000<<setw(10)<<roundf(m * 10000)/10000<<setw(8)<<roundf(fm * 10000)/10000<<setw(10)<<roundf(ss * 10000)/10000;
}
...
{
    cout<<'\n'<<setw(3)<<"n|"<<setw(8)<<"a|"<<setw(8)<<"b|"<<setw(10)<<"(a+b)/2|"<<setw(8)<<"f(m)|"<<setw(10)<<"|a-b|/2";
